...
-- analytic reports
create table analysis_issues (detector varchar not null, summary varchar not null, synopsis varchar not null, description varchar not null, seealso varchar not null, solution varchar not null, info1 varchar not null, info2 varchar not null, info3 varchar not null, confidence varchar not null, cvss3_score float not null, cvss3_vector varchar not null, source varchar not null, row varchar not null, col varchar not null, unique (detector, summary, info1, info2, info3, cvss3_score, confidence, source, row, col));
